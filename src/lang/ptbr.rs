...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do ConectBlue..."),
        ...
        ("install_tip", "Devido ao UAC, o ConectBlue não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o ConectBlue no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao ConectBlue permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao ConectBlue permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o ConectBlue use o serviço \"Acessibilidade\"."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do ConectBlue executando em segundo plano"),
        ...
        ("Show RustDesk", "Exibir ConectBlue"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do ConectBlue."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do ConectBlue."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do ConectBlue."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do ConectBlue"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o ConectBlue e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o ConectBlue funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por ConectBlue"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do ConectBlue estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço ConectBlue em segundo plano"),
        ...
        ("About RustDesk", "Sobre ConectBlue"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente ConectBlue para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o ConectBlue verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o ConectBlue ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o ConectBlue não usará mais UDP 21116, TCP 21116 será usado no lugar."),
