...
void checkUpdate() {
  if (!isWeb) {
    // ConectBlue: the update check now targets our own site/release, not
    // RustDesk's official API, so it is safe (and wanted) to run for our
    // custom-branded build too -- removed the isCustomClient() guard here.
